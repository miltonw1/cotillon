...
<div class="alert alert-block alert-success">
  <button type="button" class="close" data-dismiss="alert">&times;</button>
        <h4>Genial!</h4>
        Se ha modificado exitosamente la localidad <strong>'.$localidad['nombre_localidad'].
    '</div>';
}
echo form_open("/localidades/actualizar/".$localidad['id_localidad'] )?>
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control" name="nombre_localidad" value="<?php echo $localidad['nombre_localidad']?>" placeholder="Nombre de localidad">
