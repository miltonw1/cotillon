...
<div class="alert alert-block alert-success">
  <button type="button" class="close" data-dismiss="alert">&times;</button>
        <h4>Genial!</h4>
        Se ha modificado exitosamente el proveedor <strong>'.$proveedor['nombre_proveedor'].
    '</div>';
}
echo form_open("/proveedores/actualizar/".$proveedor['id_proveedor'])?>
  ...
  <div class="form-group">
      ...
      <label for="nombre_proveedor">Nombre<?php echo form_error("nombre_proveedor");?></label>
