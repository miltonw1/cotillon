...
<div class="alert alert-block alert-success">
  <button type="button" class="close" data-dismiss="alert">&times;</button>
        <h4>Genial!</h4>
        Se ha modificado exitosamente el producto <strong>'.$cliente['nombre_cliente'].
    '</div>';
}
...
echo form_open("/clientes/actualizar/". $cliente['id_cliente'] )?>
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control" name="nombre_cliente" placeholder="Nombre" value="<?php echo $cliente['nombre_cliente'];?>">
      ...
      <select name='id_localidad' class='form-control' placeholder="Seleccionar una localidad">
         <?php foreach ($localidades as $loc){
           $aux = '<option value="' . $loc['id_localidad'];
           $aux .= ( $localidades['id_localidad'] == $loc['id_localidad'] ) ? '" selected>' : '">';
       ...
       <textarea name="contacto" class="form-control" maxlength=255 placeholder="Descripcion"><?php echo $cliente['contacto'];?></textarea>
